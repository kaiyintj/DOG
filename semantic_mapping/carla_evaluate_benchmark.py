...
def _candidate_classes(true_class):
    ...
    group so a bicycle is never counted as ``detected`` because SegFormer painted
    it as a car. Four-wheelers compete over car/truck/bus, ridden two-wheelers
    over bicycle/motorcycle.
    """
