# Historical ARIS / Auto-Claude CARLA execution rules

> Status on the migrated B disk: historical and inactive.
> Read this file only after the user explicitly resumes the CARLA/ARIS experiment
> and the excluded CARLA installation, datasets and run root have been restored.
> Until both conditions hold, `AUTO_DEPLOY=false` and these steps must not run.
